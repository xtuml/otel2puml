...
class TestOTELDataSource:
    ...
    def test_get_yaml_config(self, mock_yaml_config, mock_path_exists):
    ...
    def test_set_file_ext_valid(self, mock_yaml_config, mock_path_exists):
        """Tests for valid file ext within the data source object."""
        data_source = JSONDataSource()
        assert data_source.file_ext == "json"

    def test_set_file_ext_invalid(self, mock_yaml_config_string):
    ...
    def test_set_dirpath_valid(self, mock_yaml_config, mock_path_exists):
        """Tests set_dirpath method."""
        data_source = JSONDataSource()
        assert data_source.dirpath == "/path/to/json/directory"

    def test_set_dirpath_invalid(self, mock_yaml_config):
    ...
    def test_set_filepath_valid(self, mock_yaml_config, mock_path_exists):
        """Tests the set_filepath method."""
        data_source = JSONDataSource()
        assert data_source.filepath == "/path/to/json/file.json"

    def test_set_filepath_invalid(self, mock_yaml_config):
